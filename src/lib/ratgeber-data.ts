...
export const ratgeberKategorien: RatgeberKategorie[] = [
  { slug: 'minijob-basics', name: 'Minijob-Basics', description: 'Grundlagen, Regeln und alles Wichtige rund um den 538-Euro-Job.' },
  { slug: 'steuern-recht', name: 'Steuern & Recht', description: 'Steuern, Abgaben, Sozialversicherung und rechtliche Rahmenbedingungen im Minijob.' },
  { slug: 'bewerbung', name: 'Bewerbung & Jobsuche', description: 'Tipps fuer die erfolgreiche Minijob-Suche und Bewerbung.' },
  { slug: 'studium-nebenjob', name: 'Studium & Nebenjob', description: 'Minijobs neben Studium, Schule oder Hauptjob - was du beachten musst.' },
  { slug: 'arbeitgeber', name: 'Fuer Arbeitgeber', description: 'Tipps und Infos fuer Arbeitgeber, die Minijobber einstellen.' },
];
