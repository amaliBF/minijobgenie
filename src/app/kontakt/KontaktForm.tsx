      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-shadow"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-shadow appearance-none bg-white"
          >
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-shadow resize-none"
          />
        </div>
        ...
        <button
          ...
          className="w-full rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 px-8 py-4 text-base font-semibold text-white hover:from-amber-600 hover:to-yellow-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-200"
        >
          {isSubmitting ? (
            <>
