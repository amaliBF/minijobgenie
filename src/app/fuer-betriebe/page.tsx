...
export const metadata: Metadata = {
  title: 'Minijobgenie für Betriebe – Minijobber finden per Video & Matching',
  description:
  ...
  openGraph: {
    title: 'Minijobber finden per Video & Matching | Minijobgenie für Betriebe',
    description:
      'Klassische Stellenanzeigen erreichen Gen Z nicht mehr. Minijobgenie verbindet Betriebe und Jugendliche durch authentische Kurzvideos und Swipe-Matching.',
    url: 'https://minijobgenie.de/fuer-betriebe',
    type: 'website',
  },
  twitter: {
...
const faqs = [
  {
    q: 'Wie viel kostet Minijobgenie für Betriebe?',
  ...
  },
  {
    ...
    a: 'Jugendliche sehen Ihre Videos im Feed und können nach rechts swipen, wenn ihnen Ihr Betrieb gefällt. Wenn Sie den Kandidaten ebenfalls spannend finden, entsteht ein Match. Erst nach dem beidseitigen Like können Sie miteinander chatten – das sorgt für qualitativ hochwertige Kontakte.',
  },
  {
  ...
  {
    q: 'Wie erreiche ich Jugendliche in meiner Region?',
    a: 'Minijobgenie zeigt Jugendlichen bevorzugt Betriebe in ihrer Nähe. Sie geben Ihren Standort bei der Registrierung an. Kandidaten können nach Umkreis filtern – so erreichen Sie genau die jungen Menschen, die in Ihrer Region eine Minijob suchen.',
  },
  {
  ...
  },
  {
    ...
    a: 'Absolut. Wir sind ein deutsches Unternehmen, unsere Server stehen in Deutschland und wir erfüllen alle Anforderungen der DSGVO. Daten werden verschlüsselt übertragen und gespeichert. Jugendliche unter 16 benötigen die Einwilligung ihrer Erziehungsberechtigten.',
  },
  {
  ...
  },
  {
    ...
    a: 'Jobbörsen setzen auf Text-Stellenanzeigen – die Gen Z nicht liest. Wir setzen auf Video, Matching und Chat. Jugendliche erleben Ihren Betrieb in 30 Sekunden, statt Fließtext zu lesen. Das Ergebnis: höhere Reichweite, bessere Passung und schnellere Besetzung.',
  },
  {
...
export default function FuerBetriebePage() {
  ...
  const webPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Minijobgenie für Betriebe – Minijobber finden per Video & Matching',
    description:
    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative bg-gray-900 pt-28 pb-20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-amber-900/40 via-gray-900 to-pink-900/30" />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-600 to-pink-600 px-8 py-4 text-base font-semibold text-white hover:from-amber-500 hover:to-pink-500 transition-all shadow-lg shadow-amber-500/25"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={card.label}
                    className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-amber-500/30 transition-colors"
                  >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Jugendliche wollen sehen, wie der Arbeitsalltag wirklich aussieht. Hochglanz-Broschüren und Stockfotos wirken abschreckend. Was zählt: echte Menschen, echte Aufgaben, echte Atmosphäre.',
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Minijobgenie verbindet Betriebe und Jugendliche auf eine völlig neue Art:
                mit Videos, Matching und Chat – dort, wo Gen Z zu Hause ist.
              </p>
            </div>

            <div className="grid lg:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-amber-600 to-amber-700 rounded-3xl p-8 text-white">
                ...
                <p className="text-amber-100 leading-relaxed mb-6">
                  Laden Sie 30-90 Sekunden Kurzvideos hoch, in denen Ihre Minijobber den Arbeitsalltag
                  zeigen. Smartphone genügt – wir kümmern uns um die technische Optimierung.
                  Jugendliche schauen sich Videos an, keine Stellenanzeigen.
                </p>
                <ul className="space-y-2">
                  {['Automatische Konvertierung (HD 720p)', 'Thumbnail-Generierung', 'Feed-Platzierung'].map((item) => (
                    <li key={item} className="flex items-center gap-2 text-sm text-amber-100">
                      <Check className="h-4 w-4 text-amber-300 flex-shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8 text-white">
                ...
                <p className="text-blue-100 leading-relaxed mb-6">
                  ...
                  Formalitäten. Jugendliche kommunizieren so, wie sie es gewohnt sind –
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Sehen Sie, welche Jugendlichen Ihre Videos geliked haben. Liken Sie zurück und schaffen Sie ein Match. Das beidseitige Like-System sorgt für qualitativ hochwertige Kontakte.',
                ...
                },
                {
                  ...
                  description:
                    'Ihr Betrieb wird Jugendlichen in Ihrer Region priorisiert angezeigt. Umkreissuche, Standort-Filter und regionale Feed-Platzierung bringen Ihnen Kandidaten aus der Nähe.',
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Kurze, authentische Videos von Ihren Minijobber und dem Arbeitsalltag. Smartphone genügt.',
                },
                {
                  icon: Heart,
                  title: 'Kandidaten matchen',
                  description:
                    'Jugendliche liken Ihre Videos. Sie liken zurück. Match! Dann chatten Sie direkt.',
                },
              ].map((item) => (
                <div key={item.title} className="relative text-center group">
                  <div className="mx-auto mb-6">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-600 to-pink-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-amber-500/20 group-hover:shadow-xl group-hover:shadow-amber-500/30 transition-shadow">
              ...
              {[
                ...
                <div
                  ...
                  className={`rounded-2xl p-8 flex flex-col ${
                    plan.highlighted
                      ? 'bg-gradient-to-br from-amber-600 to-pink-600 text-white ring-4 ring-amber-200 scale-[1.03] shadow-2xl'
                      : 'bg-white border border-gray-200 shadow-sm'
                  }`}
                >
                  {plan.highlighted && (
                    <div className="text-xs font-semibold uppercase tracking-wide text-amber-200 mb-2">
                      Empfohlen
                    </div>
                  )}
                  <h3
                  ...
                  <p className="mt-6">
                    ...
                    {plan.period && (
                      <span
                        className={`text-sm ml-1 ${plan.highlighted ? 'text-amber-200' : 'text-gray-500'}`}
                      >
                        {plan.period}
                      </span>
                    )}
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Warum Betriebe Minijobgenie vertrauen
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  title: 'DSGVO-konform',
                  description:
                    'Volle Compliance mit der Datenschutz-Grundverordnung. Verschlüsselte Datenübertragung, transparente Datenverarbeitung und klare Löschfristen. Jugendliche unter 16 benötigen die Einwilligung der Erziehungsberechtigten.',
                },
                {
                  icon: Server,
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-br from-amber-500 via-yellow-500 to-orange-500 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="https://dashboard.minijobgenie.de/login"
                className="inline-flex items-center gap-2 rounded-full bg-white px-10 py-4 text-base font-semibold text-amber-600 hover:bg-gray-100 transition-colors shadow-lg"
              >
