      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="glow-card rounded-2xl p-8 sm:p-12">
          ...
          <p className="text-gray-700 mb-2">
            ...
            <a href="https://www.ionos.de/terms-gtc/datenschutzerklaerung/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">
          ...
          <h2 className="cash-divider text-xl font-bold text-gray-900 mt-10 mb-4">Externe Dienste und Datenverarbeitung</h2>
          ...
          <p className="text-gray-700 mb-2">
            ...
            Datenschutzerklärung:{' '}
            <a href="https://www.brevo.com/de/legal/privacypolicy/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">
          ...
          <p className="text-gray-700 mb-2">
            ...
            Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse)<br />
            Datenschutzerklärung:{' '}
            <a href="https://bunny.net/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">
