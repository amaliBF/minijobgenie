...
export const metadata: Metadata = {
  ...
  description: 'Datenschutzerklärung von Minijobgenie.de',
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-28 pb-16">
        ...
        <p>
          ...
          E-Mail: <a href="mailto:kontakt@minijobgenie.de" className="text-amber-600 hover:underline">kontakt@minijobgenie.de</a>
        </p>
        ...
        <p>
          ...
          <a href="https://stripe.com/de/privacy" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:underline">
