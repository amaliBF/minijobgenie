...
export const metadata: Metadata = {
  title: 'Minijobgenie für Arbeitgeber – Minijobber finden per Video & Matching',
  description:
    'Finden Sie motivierte Minijobber mit TikTok-Style Videos, intelligentem Matching und Direkt-Chat. Erreichen Sie die Generation Z dort, wo sie ist. Ab 0 EUR/Monat.',
  alternates: { canonical: '/fuer-arbeitgeber' },
  openGraph: {
    title: 'Minijobber finden per Video & Matching | Minijobgenie für Arbeitgeber',
    description:
      'Klassische Stellenanzeigen erreichen Gen Z nicht mehr. Minijobgenie verbindet Arbeitgeber und Jobsuchende durch authentische Kurzvideos und Swipe-Matching.',
    url: 'https://minijobgenie.de/fuer-arbeitgeber',
    type: 'website',
  },
  twitter: {
...
const faqs = [
  {
    q: 'Wie viel kostet Minijobgenie für Arbeitgeber?',
  ...
  },
  {
    ...
    a: 'Am besten funktionieren authentische 30-90 Sekunden Videos, in denen echte Minijobber oder Mitarbeiter ihren Arbeitsalltag zeigen. Keine Hochglanz-Produktion nötig – Smartphone reicht! Zeigen Sie Ihren Betrieb, die Aufgaben und das Team. Authentizität schlägt Perfektion.',
  },
  {
  ...
  },
  {
    ...
    a: 'Minijobgenie zeigt Jobsuchenden bevorzugt Betriebe in ihrer Nähe. Sie geben Ihren Standort bei der Registrierung an. Kandidaten können nach Umkreis filtern – so erreichen Sie genau die Menschen, die in Ihrer Region einen Minijob suchen.',
  },
  {
    q: 'Kann ich mehrere Mitarbeiter einladen?',
    a: 'Ja! Ab dem Professional-Plan können Sie mehrere Team-Mitglieder einladen. Jeder Mitarbeiter erhält eigene Zugangsdaten und kann Videos hochladen, Kandidaten bewerten und chatten. Ideal für größere Betriebe.',
  },
  {
    q: 'Ist Minijobgenie DSGVO-konform?',
    a: 'Absolut. Wir sind ein deutsches Unternehmen, unsere Server stehen in Deutschland und wir erfüllen alle Anforderungen der DSGVO. Daten werden verschlüsselt übertragen und gespeichert.',
  },
  {
  ...
  {
    q: 'Was unterscheidet Minijobgenie von klassischen Jobbörsen?',
    a: 'Jobbörsen setzen auf Text-Stellenanzeigen – die Gen Z nicht liest. Wir setzen auf Video, Matching und Chat. Jobsuchende erleben Ihren Betrieb in 30 Sekunden, statt Fließtext zu lesen. Das Ergebnis: höhere Reichweite, bessere Passung und schnellere Besetzung.',
  },
  {
...
export default function FuerArbeitgeberPage() {
  ...
  const webPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Minijobgenie für Arbeitgeber – Minijobber finden per Video & Matching',
    description:
      'Finden Sie motivierte Minijobber mit TikTok-Style Videos, intelligentem Matching und Direkt-Chat.',
    url: 'https://minijobgenie.de/fuer-arbeitgeber',
    publisher: {
      '@type': 'Organization',
      name: 'Minijobgenie',
    ...
    <>
      ...
      <main className="min-h-screen bg-[#F0FDF4]">
        ...
        <section className="relative bg-gray-900 pt-28 pb-20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/40 via-gray-900 to-green-900/30" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm text-gray-400 mb-8" aria-label="Breadcrumb">
              <ol className="flex items-center gap-1">
                ...
                <li>/</li>
                <li className="text-white font-medium">Für Arbeitgeber</li>
              </ol>
            </nav>

            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-lg bg-emerald-500/20 border border-emerald-500/30 px-4 py-1.5 text-sm text-emerald-300 mb-6">
                  <Building2 className="h-4 w-4" />
                  Für Arbeitgeber
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight">
                  Finden Sie die besten Minijobber –{' '}
                ...
                <p className="mt-6 text-xl text-gray-300 max-w-xl">
                  ...
                  authentischen Kurzvideos und finden Sie motivierte Minijobber per Matching.
                </p>
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    href="#so-starten-sie"
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-600 px-8 py-4 text-base font-medium text-gray-200 hover:bg-white/5 transition-colors"
                  >
                    So funktioniert&apos;s
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="cash-divider mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">DIE HERAUSFORDERUNG</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Warum klassisches Minijobber-Recruiting nicht mehr funktioniert
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  stat: '73%',
                  title: 'der Minijobber-Stellen bleiben unbesetzt',
                  description:
                    'Immer mehr Betriebe finden keine Aushilfen. Die Zahl der unbesetzten Stellen erreicht jedes Jahr neue Rekordwerte. Besonders betroffen: Handwerk, Gastronomie und Einzelhandel.',
                ...
                },
                {
                  ...
                  description:
                    'Lange Stellenanzeigen mit Fließtext? Werden nicht gelesen. Gen Z ist mit TikTok, Instagram und YouTube aufgewachsen. Sie entscheiden in Sekunden, ob etwas relevant ist.',
                ...
                },
                {
                  ...
                  description:
                    'Jobsuchende wollen sehen, wie der Arbeitsalltag wirklich aussieht. Hochglanz-Broschüren und Stockfotos wirken abschreckend. Was zählt: echte Menschen, echte Aufgaben.',
        ...
        <section className="py-20 bg-[#F0FDF4]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="cash-divider mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">UNSERE LÖSUNG</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                So erreichen Sie die Generation Z
              </h2>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Minijobgenie verbindet Betriebe und Jobsuchende auf eine völlig neue Art:
                mit Videos, Matching und Chat – dort, wo Gen Z zu Hause ist.
              </p>
            </div>

            <div className="grid lg:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-3xl p-8 text-white shadow-xl shadow-emerald-500/15">
              ...
              <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-3xl p-8 text-white shadow-xl shadow-green-500/15">
                <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center mb-6">
              ...
              <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-3xl p-8 text-white shadow-xl shadow-teal-500/15">
                <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center mb-6">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Alles, was Sie für erfolgreiches Minijobber-Recruiting brauchen
              </h2>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Von Video-Upload bis Analytics – unser Dashboard bietet Ihnen alle Werkzeuge,
                um die besten Aushilfen zu finden und zu begeistern.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Laden Sie HR-Mitarbeiter als Team-Mitglieder ein. Jeder erhält eigene Zugangsdaten und kann eigenständig Videos hochladen, Kandidaten bewerten und chatten.',
                },
                {
                  icon: Building2,
                  title: 'Firmenprofil',
                ...
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-emerald-100 text-emerald-600 mb-5">
        ...
        {/* How to Start */}
        <section id="so-starten-sie" className="py-20 bg-[#F0FDF4]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="cash-divider mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">LOS GEHT&apos;S</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Kurze, authentische Videos von Ihren Mitarbeitern und dem Arbeitsalltag. Smartphone genügt.',
                },
                {
                  icon: Heart,
                ...
                <div key={item.title} className="relative text-center group">
                  <div className="mx-auto mb-6">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-emerald-500/20 group-hover:shadow-xl group-hover:shadow-emerald-500/30 transition-shadow">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="cash-divider mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">PREISE</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              ...
              {[
                ...
                <div
                  ...
                  className={`rounded-2xl p-8 flex flex-col ${
                    plan.highlighted
                      ? 'bg-gradient-to-br from-emerald-500 to-green-600 text-white ring-4 ring-emerald-200 scale-[1.03] shadow-2xl shadow-emerald-500/20'
                      : 'bg-white border border-emerald-100 shadow-sm glow-card'
                  }`}
                >
                  {plan.highlighted && (
                    <div className="quick-tag mb-2">
                      Empfohlen
                    </div>
                  )}
                  <h3
                  ...
                  <p className="mt-6">
                    ...
                    {plan.period && (
                      <span
                        className={`text-sm ml-1 ${plan.highlighted ? 'text-emerald-100' : 'text-gray-500'}`}
                      >
                        {plan.period}
                      </span>
                    )}
        ...
        <section className="py-20 bg-[#F0FDF4]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="cash-divider mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">VERTRAUEN</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Warum Arbeitgeber Minijobgenie vertrauen
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  title: 'DSGVO-konform',
                  description:
                    'Volle Compliance mit der Datenschutz-Grundverordnung. Verschlüsselte Datenübertragung, transparente Datenverarbeitung und klare Löschfristen.',
                },
                {
                  icon: Server,
                  title: 'Deutsche Server',
                  description:
                    'Alle Daten werden auf Servern in Deutschland gespeichert und verarbeitet. Kein Transfer in Drittländer. Ihre Daten und die Ihrer Kandidaten sind sicher.',
                },
                {
                  icon: Headphones,
                  title: 'Persönlicher Support',
                  description:
                    'Unser deutschsprachiges Support-Team hilft Ihnen bei allen Fragen – von der Einrichtung bis zur Optimierung Ihrer Videos. Per E-Mail und Chat.',
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="text-center p-8 rounded-2xl glow-card"
                >
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div
                  key={badge.label}
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-medium"
                >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <details
                  key={index}
                  className="group glow-card rounded-2xl"
                >
                  <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                    <h3 className="text-lg font-semibold text-gray-900 pr-4">{faq.q}</h3>
                    <ChevronDown className="h-5 w-5 text-emerald-500 flex-shrink-0 group-open:rotate-180 transition-transform" />
                  </summary>
