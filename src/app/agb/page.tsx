...
export const metadata: Metadata = {
  ...
  description: 'Allgemeine Geschäftsbedingungen von Minijobgenie.de',
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-28 pb-16">
        ...
        <ul className="list-disc list-inside mb-4 mt-2">
          ...
          <li>Ein Dashboard fuer Arbeitgeber zur Verwaltung von Stellenanzeigen, Videos und Kandidaten</li>
        </ul>
        ...
        <p>
          <strong>Fuer Jobsuchende:</strong> Die Nutzung der Plattform ist vollständig kostenlos.
        </p>
        <p className="mt-2">
          <strong>Fuer Arbeitgeber:</strong> Es stehen verschiedene Abonnement-Modelle zur Verfügung
